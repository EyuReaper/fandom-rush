...
export function ScoreDisplay({
  ...
  return (
    <div className="text-right">
      ...
      <div className="text-4xl sm:text-6xl font-black font-mono tabular-nums tracking-tighter text-white drop-shadow-[0_0_30px_rgba(255,255,255,0.1)] leading-none">
